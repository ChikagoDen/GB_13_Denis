    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
            ...
            <p class="text-muted">Наш сайт предостовляет самую правдивую и актуальную информацию.
              Здесь вы найдете много интересного и позновательного.
            </p>
        </div>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        ...
        <strong>Правдивый новостной канал "Сплетни"</strong>
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarHeader" aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
            ...
            {{-- //////////////////////// --}}
            @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block" style="display:block; width: 100px; ">
                @auth
